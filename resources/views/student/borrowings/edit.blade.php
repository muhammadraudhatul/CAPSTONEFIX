    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .modal-card {
            ...
            position: relative;
            animation: editFadeUp 0.38s ease both;
        }
        ...
        <div class="modal-card">
            ...
            <aside class="borrow-side">
                <div class="side-content">
                    ...
                    <h1 class="side-title">
                        Perbarui<br><span>Peminjaman</span>
                    </h1>
                    <p class="side-copy">
                        Ubah detail pengajuan peminjaman sebelum diproses. Pastikan tanggal, ruangan, waktu, dan alat yang dipinjam sudah sesuai.
                    </p>

                    <ul class="side-list">
                        <li>
                            <span class="side-list-icon">1</span>
                            Cek ulang tanggal, ruangan, dan slot waktu
                        </li>
                        <li>
                            <span class="side-list-icon">2</span>
                            Perbarui keperluan dan jumlah pengguna
                        </li>
                        <li>
                            <span class="side-list-icon">3</span>
                            Sesuaikan alat dan jumlah peminjaman
                        </li>
                    </ul>
                </div>
            ...
            <div class="modal-main">
                ...
                <div class="modal-body">
                    ...
                    <div class="title-row">
                        ...
                        <div>
                            <p class="modal-title">Edit Peminjaman</p>
                            <p class="modal-subtitle">Sesuaikan data peminjaman laboratorium dengan benar.</p>
                        </div>
                    </div>
                    ...
                    <form
                        method="POST"
                        action="{{ route('student.borrowings.update', $borrowing) }}"
                        id="theForm"
                    >
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-grid">
                            ...
                            <div class="field">
                                ...
                                <select name="room_id" x-model="room_id" @change="loadSchedules" required>
                                    ...
                                    @foreach($rooms as $room)
                                        <option
                                            value="{{ $room->id }}"
                                            @selected($borrowing->room_id == $room->id)
                                        >
                                            {{ $room->name }}
                                        </option>
                                    @endforeach
                                ...
                                <select name="time_slot" required>
                                    ...
                                    <template x-for="slot in schedules">
                                        <option
                                            ...
                                            :selected="slot.time_slot == '{{ $borrowing->time_slot }}'"
                            ...
                            <div class="field full">
                                ...
                                <textarea name="purpose" rows="4" required placeholder="Jelaskan keperluan peminjaman">{{ $borrowing->purpose }}</textarea>
                            </div>
                                        ...
                                        <div class="item-row">
                                            ...
                                            <div>
                                                <input
                                                    ...
                                                    placeholder="Qty"
                                                >
                                                <p class="field-hint" x-show="item.max_stock">
                                                    Maks: <span x-text="item.max_stock"></span>
                                                </p>
                                            </div>
                ...
                <div class="modal-actions">
                    <button type="submit" form="theForm" class="btn-submit">Update Peminjaman</button>
