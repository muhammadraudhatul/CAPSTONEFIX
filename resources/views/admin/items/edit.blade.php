...
<style>
    /* ── Flip7 muted edit item page: hanya desain, logic/form tetap dipertahankan ── */
    .item-edit-flip7-wrapper {
        --primary-teal:  #4B958F;
    ...
    .item-edit-flip7-wrapper *,
    .item-edit-flip7-wrapper *::before,
    .item-edit-flip7-wrapper *::after {
    ...
    .item-edit-header,
    .form-card {
        animation: itemEditFadeUp 0.35s ease both;
    }
...
<div class="item-edit-flip7-wrapper">
    <div class="item-edit-flip7-main">

        <!-- HEADER -->
        <div class="item-edit-header">
            <div class="item-edit-title-block">
                <h1 class="item-edit-title">
                    Edit Item
                </h1>
                <p class="item-edit-subtitle">
