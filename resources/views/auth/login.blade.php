        ...
        <div class="auth-shell">
            ...
            <aside class="brand-panel">
                <div class="brand-content">
                    ...
                    <h2 class="brand-title">
                        Selamat Datang<br><span>Mahasiswa</span>
                    </h2>
                    <p class="brand-copy">
                        Akses layanan peminjaman laboratorium, kelola reservasi, dan pantau aktivitas peminjaman alat.
                    </p>

                    <ul class="brand-list">
                        <li>
                            <span class="brand-list-icon"><i class="ti ti-clipboard-list"></i></span>
                            Ajukan dan pantau permintaan peminjaman
                        </li>
                        <li>
                            <span class="brand-list-icon"><i class="ti ti-calendar-time"></i></span>
                            Cek jadwal dan ketersediaan ruangan
                        </li>
                        <li>
                            <span class="brand-list-icon"><i class="ti ti-box"></i></span>
                            Pantau peminjaman alat laboratorium
                        </li>
                    </ul>
                </div>
            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <h1>Mahasiswa</h1>
                    <p class="subtitle">Masuk untuk mengelola peminjaman alat</p>
                    ...
                    <div class="student-note">
                        ...
                        <span>Gunakan NIM dan kata sandi yang terdaftar untuk mengakses dashboard peminjaman mahasiswa.</span>
                    </div>
